...
describe('Login page', function () {
  ...
  it('Successful login with valid credentials', async function () {
    await driver.findElement(By.xpath('//input[@placeholder = "Enter username"]')).sendKeys('Aleena0207');
    await driver.findElement(By.xpath('//input[@placeholder = "Enter password"]')).sendKeys('Aleena02072002');
  ...
  it('Fail login with incorrect password', async function () {
    await driver.findElement(By.xpath('//input[@placeholder = "Enter username"]')).sendKeys('Aleena0207');
    await driver.findElement(By.xpath('//input[@placeholder = "Enter password"]')).sendKeys('WrongPassword');
    await driver.findElement(By.xpath('//button[text() = "Submit"]')).click();
  ...
  it('Fail login with invalid email format', async function () {
    await driver.findElement(By.xpath('//input[@placeholder = "Enter username"]')).sendKeys('notanemail');
    await driver.findElement(By.xpath('//input[@placeholder = "Enter password"]')).sendKeys('Aleena02072002');
    await driver.findElement(By.xpath('//button[text() = "Submit"]')).click();
