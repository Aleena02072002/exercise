...
describe('Register page', function () {
    ...
    it('Successful Register', async function () {
       ...
       this.timeout(10000);
        ...
        try {
            const emailBox = await driver.wait(until.elementLocated(By.xpath('//input[@placeholder = "Enter your email"]')), 5000);
            await emailBox.sendKeys('Ly_02');
            const passBox = await driver.wait(until.elementLocated(By.xpath('//input[@placeholder = "Enter password"]')), 5000);
            await passBox.sendKeys('Aleena02072002');
            const registerButton = await driver.wait(until.elementLocated(By.xpath('//button[text() = "Register"]')), 5000);
