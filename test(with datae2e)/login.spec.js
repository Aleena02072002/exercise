...
describe('Login page', function () {
  ...
  it('Successful login with valid credentials', async function () {
    await driver.findElement(By.css('[data-e2e = "txtUsername"]')).sendKeys('Aleena0207');
    await driver.findElement(By.css('[data-e2e = "txtPassword"]')).sendKeys('Aleena02072002');
    await driver.findElement(By.css('[data-e2e = "btnSubmit"]')).click();
  ...
  it('Fail login with incorrect password', async function () {
    await driver.findElement(By.css('[data-e2e = "txtUsername"]')).sendKeys('Aleena0207');
    await driver.findElement(By.css('[data-e2e = "txtPassword"]')).sendKeys('WrongPassword');
    await driver.findElement(By.css('[data-e2e = "btnSubmit"]')).click();
  ...
  it('Fail login with invalid email format', async function () {
    await driver.findElement(By.css('[data-e2e = "txtUsername"]')).sendKeys('notanemail');
    await driver.findElement(By.css('[data-e2e = "txtPassword"]')).sendKeys('Aleena02072002');
    await driver.findElement(By.css('[data-e2e = "btnSubmit"]')).click();
