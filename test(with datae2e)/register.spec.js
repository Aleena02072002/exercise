...
describe('Register page', function () {
    ...
    it('Successful Register', async function () {
       ...
       this.timeout(10000);
        ...
        try {
            const emailBox = await driver.wait(until.elementLocated(By.css('[data-e2e="txtUsername"]')), 5000);
            await emailBox.sendKeys('Ly_05');
            const passBox = await driver.wait(until.elementLocated(By.css('[data-e2e="txtPassword"]')), 5000);
            await passBox.sendKeys('Aleena02072002');
            const registerButton = await driver.wait(until.elementLocated(By.css('[data-e2e = "btnSubmit"]')), 5000);
